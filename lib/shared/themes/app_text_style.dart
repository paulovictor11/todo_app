...
class AppTextStyles {
  ...
  static final titleHomeBackground = GoogleFonts.lexendDeca(
    fontSize: 32,
    fontWeight: FontWeight.w600,
  ...
  static final titleRegularPrimary = GoogleFonts.lexendDeca(
    fontSize: 20,
    fontWeight: FontWeight.w400,
    color: AppColors.primary,
  );
  static final titleBoldHeadingPrimary = GoogleFonts.lexendDeca(
    fontSize: 20,
    fontWeight: FontWeight.w600,
    color: AppColors.primary,
  );
  ...
  static final titleListTileBackground = GoogleFonts.lexendDeca(
    fontSize: 17,
    fontWeight: FontWeight.w600,
    color: AppColors.background,
  );
  ...
  static final captionBoldBodyPrimary = GoogleFonts.inter(
    fontSize: 13,
    fontWeight: FontWeight.w600,
    color: AppColors.primary
  );
